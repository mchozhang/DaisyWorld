...
class World:
    def __init__(self, data):
        ...
        # initial percentage of white and black daisies in the world
        ...
        # initialize constants of class Patch
        ...
        # init global statistics, which will be output as results
    ...
    def adjust_solar_luminosity(self, tick):
        ...
        :param tick: the tick number
        """
        # the solar energy first goes up, waits for a period then goes down
