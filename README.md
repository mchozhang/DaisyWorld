...
In the tool `BehaviorSpace` in NetLogo, use the following settings:
...
<small><center>The left diagrams are generated by `matplotlib` using the `csv` output data</center></small>
